...
insert into clients (id, name, sector, city, whatsapp_phone, status, tone, demo_mode) values
  ('11111111-1111-4111-a111-111111111111', 'Chez Demba', 'restaurant', 'Angers', '+33612340001', 'actif', 'chaleureux', true),
  ('22222222-2222-4222-a222-222222222222', 'Salon Belle Époque', 'beaute', 'Angers', '+33612340002', 'actif', 'premium', true),
  ('33333333-3333-4333-a333-333333333333', 'Boutique Wax & Style', 'commerce', 'Nantes', '+33612340003', 'actif', 'jeune', true),
  ('44444444-4444-4444-a444-444444444444', 'Association Teranga 49', 'association', 'Angers', '+33612340004', 'actif', 'communautaire', true),
  ('55555555-5555-4555-a555-555555555555', 'Kaay Fecc Events', 'evenementiel', 'Paris', '+33612340005', 'actif', 'jeune', true)
...
insert into contacts (client_id, first_name, last_name, phone, category, city, consent, consent_source, consent_date, status) values
  ...
  ('11111111-1111-4111-a111-111111111111','Awa','Diallo','+33612345001','vip','Angers',true,'carte fidélité',now(),'actif'),
  ('11111111-1111-4111-a111-111111111111','Moussa','Traoré','+33612345002','sport','Angers',true,'soirée match janvier',now(),'actif'),
  ('11111111-1111-4111-a111-111111111111','Fatou','Ndiaye','+33612345003','clients_habitues','Angers',true,'carte fidélité',now(),'actif'),
  ('11111111-1111-4111-a111-111111111111','Ibrahim','Koné','+33612345004','sport','Angers',true,'inscription WhatsApp comptoir',now(),'actif'),
  ('11111111-1111-4111-a111-111111111111','Aminata','Cissé','+33612345005','vip','Angers',true,'carte fidélité',now(),'actif'),
  ('11111111-1111-4111-a111-111111111111','Jean','Martin','+33612345006','clients_habitues','Angers',true,'carte fidélité',now(),'actif'),
  -- Salon Belle Époque (beauté)
  ('22222222-2222-4222-a222-222222222222','Chloé','Dubois','+33612345011','clients_habitues','Angers',true,'fiche cliente',now(),'actif'),
  ('22222222-2222-4222-a222-222222222222','Mariam','Sow','+33612345012','vip','Angers',true,'fiche cliente',now(),'actif'),
  ('22222222-2222-4222-a222-222222222222','Léa','Bernard','+33612345013','beaute','Angers',true,'prise de RDV en ligne',now(),'actif'),
  ('22222222-2222-4222-a222-222222222222','Sophie','Petit','+33612345014','clients_habitues','Angers',true,'fiche cliente',now(),'actif'),
  -- Boutique Wax & Style (commerce)
  ('33333333-3333-4333-a333-333333333333','Aïcha','Bamba','+33612345021','vip','Nantes',true,'programme fidélité',now(),'actif'),
  ('33333333-3333-4333-a333-333333333333','Nadia','Benali','+33612345022','clients_habitues','Nantes',true,'achat en boutique',now(),'actif'),
  ('33333333-3333-4333-a333-333333333333','Grace','Okafor','+33612345023','vip','Nantes',true,'programme fidélité',now(),'actif'),
  ('33333333-3333-4333-a333-333333333333','Emma','Leroy','+33612345024','prospects','Nantes',true,'jeu concours Instagram',now(),'actif'),
  -- Association Teranga 49
  ('44444444-4444-4444-a444-444444444444','Ousmane','Fall','+33612345031','association','Angers',true,'adhésion 2026',now(),'actif'),
  ('44444444-4444-4444-a444-444444444444','Khady','Sarr','+33612345032','association','Angers',true,'adhésion 2026',now(),'actif'),
  ('44444444-4444-4444-a444-444444444444','Mamadou','Ba','+33612345033','famille','Angers',true,'adhésion 2026',now(),'actif'),
  -- Kaay Fecc Events
  ('55555555-5555-4555-a555-555555555555','Binta','Camara','+33612345041','evenementiel','Paris',true,'billetterie soirée mars',now(),'actif'),
  ('55555555-5555-4555-a555-555555555555','Sékou','Doumbia','+33612345042','etudiants','Paris',true,'billetterie soirée mars',now(),'actif'),
  ('55555555-5555-4555-a555-555555555555','Yasmine','Haddad','+33612345043','vip','Paris',true,'liste VIP promoteur',now(),'actif')
